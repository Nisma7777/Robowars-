...
In our bot, we did not use any resistors or capcitor it was a low-powered bo,t anthe d voltage was already controlled.
As for the body of our bot, we modified an existing 3D model of sumo bot body in TinkerCad 
